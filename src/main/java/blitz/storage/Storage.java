    ...
    public static ArrayList<Task> loadTasks() throws IOException {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (task != null) {
                    assert task.getDescription() != null : "Task description should not be null!";  // Added assertion
        ...
        assert tasks != null : "Loaded tasks list should not be null!";  // Added assertion
        return tasks;
    }
